 ...
 ******************************************************************************
 ...
 Alle Anfragen laufen ueber /core20/main.inc.php in der folgenden Form:
 ...
 ******************************************************************************
 Alle Objekte aller Klassen muessen mit folgendem Aufruf erzeugt werden:
 ...
 der By-Reference-Rueckgabe zwingend (bei By-Reference-Parametern ist das "&"
 nicht notwendig).  Wie auch immer, diese Vorgehensweise erlaubt Modulen
 Funktionen und Klassen beliebig zu Ueberschreiben, indem die abgeleitete Klasse 
...
function &createWisyObject($className, &$anyobject, $anyparam = 0)
{
	...
	if( !defined('WISY_MODULES_LOADED') )
	{
		...
		if (!isset($wisyPortalEinstellungen['module']))
 {
	$wisyPortalEinstellungen['module']= '';
 }
