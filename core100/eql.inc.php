...
EQL rough overview:
  ...
  DATE(TIMEWINDOW(12)) MAINAREA(P) AND (TEXT(PHRASE(iff)) OR TEXT(turner) OR TEXT(PHRASE(institut f�r finanzdienstleistungen)) OR TEXT(reifner) OR TEXT(tiffe) OR TEXT(springeneer) OR TEXT(jaquemoth))
= timewindow(12) mainarea(p) oneof(iff turner "institut f�r finanzdienstleistungen" reifner tiffe springeneer jaquemoth)
=============================================================================*/
