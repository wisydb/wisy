...
<style type="text/css">
 ...
 background-image: url(/ki_admin/skins/default/img/csv.jpg);
...
?>
 ...
 <script>
  /*	window.lib_path = "/ki_admin/lib/linestat/"; */
  window.grtitle = "Anzahl freigeschalteter <span style='color: <?php echo $strokeColor; ?>;'><?php echo $what_selected; ?></span>";
  window.inputCSV = "<?php echo 'https://'.(isset($_SERVER['SERVER_NAME']) ? $_SERVER['SERVER_NAME'] : '').'/ki_admin/'.$output_path.$what_selected.'_'.$portal_id.'.csv'; ?>";
