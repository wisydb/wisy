...
?>
	...
	if(isset($_GET['menucache']) && $_GET['menucache'] == "delete") {
		...
		echo "<h2>Men&uuml;-Cache gel&ouml;scht!</h2><br><br>";
	}
	...
	?>
		...
		<form action="<?php echo $_SERVER['PHP_SELF']."?module=".$_GET['module']."&searchcache=delete&id=".$portal_id; ?>" method="POST">
	...
	if(isset($_GET['searchcache']) && $_GET['searchcache'] == "delete") {
		...
		echo "<h2>Such-Cache gel&ouml;scht!</h2>";
	}
