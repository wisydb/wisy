...
if ($select_numrows) {
	...
	echo " &nbsp; <a href='#' rel='noopener noreferrer' onclick='exportTableToCSV( document, \"table.tb > thead tr\", \"table.tb > tbody tr\" )' id='csvExportTable'><img src='/ki_admin/lib/exp/CSV.png' style='height:20px;' alt='Exportiere Tabelle dieser Ansicht als CSV-Datei'></a>";

	echo " &nbsp; <a href='#' rel='noopener noreferrer' onclick='exportTableToCSV( document, false, \"table tr\", \"/ki_admin/print.php?table=kurse&id=&prevview=list&printArea=selected&view=list&pagebreak=0&repeathead=1&ok=Drucken\" )' id='csvExportTable'><img src='/ki_admin/lib/exp/CSV_plus.png' style='height:20px;' alt='Exportiere Tabelle aller Reiter als CSV-Datei'></a>";
