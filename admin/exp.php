...
example URL for a direct dump:
	http://www.kursportal.local/admin/exp.php?exp=mix&table=kurse&q=modified%3E1.10.2012
	http://www.kursportal.local/admin/exp.php?exp=mix&table=anbieter&q=modified%3Dtoday
