...
function sysloc_new($f, $scope, $op)
{
	...
	form_hidden('f', $f);
		...
		form_control_start(htmlconstant('_ID'), $error_id);
			...
			if( $scope == 'lang' ) {
				$hint = htmlconstant('_SYSLOC_NEWLANGHINT', '<a href="http:/'.'/www.ietf.org/rfc/rfc1766.txt" target="_blank" rel="noopener noreferrer">RFC 1766</a>', '<a href="http:/'.'/www.oasis-open.org/cover/iso639a.html" target="_blank" rel="noopener noreferrer">ISO 639</a>');
			}
			else {
