<?php
global $esco_competence, $esco_profession, $esco_synonym;
...
.e_attractype<?php echo $esco_competence; ?>, .e_attractype<?php echo $esco_synonym; ?>, .e_attractype<?php echo $esco_profession; ?> { /* ESCO-Typen */
	background-color: #A2E9FF;
}

.v_attractype<?php echo $esco_competence; ?> { /* ESCO-Vorschlaege */
	background-color: #EEEE00;
}

.s_attractype<?php echo $esco_competence; ?> { /* vorausgewaehlte ESCO-Vorschlaege */
