    ...
    <main>
        ...
        <div class="tabs">
            ...
            <div class="tabmenu">
                ...
                <button class="tablink" value="Testcase6">WISY Sachstichworte</button>
                <button class="tablink" value="Testcase7">ESCO Kompetenzen & WISY Sachstichworte</button>
            </div>
            ...
            <div id="Testcase2" class="tabcontent">
                ...
                <input type="text" placeholder="koch" name="esco-concept-select-select" class="esco-autocomplete" esco-type="concept" esco-scheme="skills-hierarchy">
            ...
            <div id="Testcase7" class="tabcontent">
                <h2>Über welche Kompetenzen verfügst Du, was kannst Du gut?</h2>
                <input type="text" placeholder="koch" name="esco-skill-select" class="esco-autocomplete" esco-type="skill" esco-scheme="sachstichwort member-skills">
                <output name="esco-skill-autocomplete" for="esco-skill-select"></output>
            </div>
        </div>
