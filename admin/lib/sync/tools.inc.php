...
===============================================================================
Diese Klasse kümmert sich um die Vergabe eindeutiger IDs verschiedener 
Instanzen des Programms.
Hierzu werden bei Bedarf Trigger für alle Tabellen der Datenbank angelegt;
...
auf die neuenn Domains und nDatenbank anzupassen bzw. diese hinzuzufügen.
=============================================================================*/
...
class SYNC_TOOLS_CLASS
{
	...
	function validate_sync_values(&$msg, &$msgtype)
	{
		...
		if( $sync_info['dbs'] == '*' ) {
			$msg .= "TABLE_SYNCABLE warning: Unique algorithm missing for ID calculation in database '{$this->db->Database}'. <b>You won't be able to synchonize your records with other installations!</b> Please contact bpetersen at b44t dotcom and set up the table sync_src properly.\n";
