 ...
 ******************************************************************************
 ...
 Weitere Details zu den URLs unter http://b2b.wisy.info/index.php?title=Neue_URLs
 ******************************************************************************/
 ...
 ******************************************************************************
 ...
 Details unter http://b2b.wisy.info/index.php?title=Portalmodule
 ******************************************************************************/
			...
			for( $m = 0; $m < sizeof($module); $m++ )
			{
				...
				if( $file != '' )
				{
					if( !file_exists($file) )
					{
						...
						die("Fehler in createWisyObject(): Kann Modul &quot;$file&quot; nicht öffnen. Bitte ueberpruefen Sie Ihre Portaleinstellungen oder kontaktieren Sie den zustaendigen Administrator.");
					}
					else
					{
						require_once($file);
