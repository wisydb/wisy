...
{
	// jqObj ist der Text; ein click hierauf soll das nebenliegende <input type=hidden> ï¿½ndern
...
$().ready(function()
{
	...
	if( typeof askfwd != 'undefined' ) {
		if( confirm('Von dieser Webseite gibt es auch eine Mobilversion unter ' + askfwd + '. Mï¿½chten Sie jetzt dorthin wechseln?') ) {
