...
class WISY_OPENSEARCH_RENDERER_CLASS
{
	...
	function render()
	{
		...
		echo '<OpenSearchDescription xmlns="http:/'.'/a9.com/-/spec/opensearch/1.1/" xmlns:moz="http:/'.'/www.mozilla.org/2006/browser/search/">' . "\n";
			echo '  <ShortName>' . isohtmlspecialchars(utf8_encode($wisyPortalKurzname)) . '</ShortName>' . "\n";
			echo '  <Description>' . isohtmlspecialchars(utf8_encode($wisyPortalName)) . '</Description>' . "\n";
