...
class WISY_ANBIETER_RENDERER_CLASS
{
	...
	function render()
	{
		...
		if( !$db->next_record() ) {
			$this->framework->error404(); // record does not exist, reporta normal 404 error, not a "Soft 404", see  http://goo.gl/IKMnm -- f�r nicht-freigeschaltete Datens�tze, s. [here]
		}
